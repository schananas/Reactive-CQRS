package com.github.stefanvozd.cqrs.reactiveaxon.input.rest;

import com.github.stefanvozd.cqrs.reactiveaxon.api.*;
import com.github.stefanvozd.cqrs.reactiveaxon.projection.reactive.AccountQueryUpdate;
import com.github.stefanvozd.cqrs.reactiveaxon.projection.reactive.AccountSummary;
import com.github.stefanvozd.cqrs.reactiveaxon.projection.reactive.FindProjectionProducedByCommand;
...
public class WebFluxRest {
    ...
    private Mono<AccountSummary> getProjectionProducedByCommand(
        ...
        SubscriptionQueryResult<Void, AccountQueryUpdate> queryResult = queryGateway
                .subscriptionQuery(
                        new FindProjectionProducedByCommand(openAccountCmd.getCommandId()),
